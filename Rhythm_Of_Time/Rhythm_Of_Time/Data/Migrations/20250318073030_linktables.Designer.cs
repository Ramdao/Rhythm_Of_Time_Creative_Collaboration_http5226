...
namespace Rhythm_Of_Time.Data.Migrations
{
    ...
    [Migration("20250318073030_linktables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rhythm_Of_Time.Models.ArtistSong", b =>
                {
                    b.Property<int>("ArtistSong_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArtistSong_Id"));
            ...
            modelBuilder.Entity("Rhythm_Of_Time.Models.AwardSong", b =>
                {
                    b.Property<int>("AwardSong_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AwardSong_Id"));
                    ...
                    b.HasKey("AwardSong_Id");

                    b.HasIndex("AwardId");

                    b.HasIndex("SongId");

                    b.ToTable("awardSongs");
                });
            ...
            modelBuilder.Entity("Rhythm_Of_Time.Models.ArtistSong", b =>
                {
                    b.HasOne("Rhythm_Of_Time.Models.Artist", "Artist")
                        .WithMany()
            ...
            modelBuilder.Entity("Rhythm_Of_Time.Models.AwardSong", b =>
                {
                    b.HasOne("Rhythm_Of_Time.Models.Award", "Award")
                        .WithMany()
